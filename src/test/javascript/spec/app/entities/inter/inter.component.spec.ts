...
import { InterComponent } from 'app/entities/inter/inter.component';
import { InterService } from 'app/entities/inter/inter.service';
import { Inter } from 'app/shared/model/inter.model';

describe('Component Tests', () => {
  describe('Inter Management Component', () => {
    let comp: InterComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InterComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.inters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
/**
 * REST controller for managing {@link com.cheroliv.fiber.domain.Planning}.
 */
@RestController
@RequestMapping("/api")
public class PlanningResource {
    ...
    public ResponseEntity<Planning> createPlanning(@Valid @RequestBody Planning planning) throws URISyntaxException {
    ...
    public ResponseEntity<Planning> updatePlanning(@Valid @RequestBody Planning planning) throws URISyntaxException {
    ...
    public ResponseEntity<List<Planning>> getAllPlannings(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
